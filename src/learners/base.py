...
class BaseLearner(torch.nn.Module):
    ...
    def evaluate_offline(self, dataloaders, epoch):
        ...
        with torch.no_grad():
            ...
            # train_representations = self.model.encoder(imgs)
    ...
    def encode(self, dataloader, nbatches=-1):
        ...
        with torch.no_grad():
            for sample in dataloader:
                ...
                # features = self.model.encoder(self.transform_test(inputs))
